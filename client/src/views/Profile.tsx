      ...
      <Wrapper>
        ...
        <Content>
          ...
          <Card onClick={() => editHandler(0)}>
            ...
            <InfoWrapper>
              <Name>{userContext.state.profile[0].name}</Name>
              <Bio>{userContext.state.profile[0].bio}</Bio>
            </InfoWrapper>
          </Card>
          ...
          <Card onClick={() => editHandler(1)}>
            ...
            <InfoWrapper>
              <Name>{userContext.state.profile[1].name}</Name>
              <Bio>{userContext.state.profile[1].bio}</Bio>
            </InfoWrapper>
          </Card>
        </Content>
      </Wrapper>
